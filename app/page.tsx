...
export default function Home() {
  return (
    <main className="min-h-screen relative">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:px-8 lg:py-16 relative z-10">
        ...
        <header className="mb-16 animate-slide-in-up">
          <div className="inline-flex items-center gap-3 mb-6 px-4 py-2 rounded-full bg-primary/5 border border-primary/10">
            ...
            <span className="text-sm font-medium text-primary">AI-Powered Product Management</span>
          </div>
